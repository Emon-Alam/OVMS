                ...
                <div class="card chat-card">
                    <ul class="list-group list-group-flush pt-3">
                        ...
                        <div class="row py-5 g-0 justify-content-around">
                            <div class="col-7">
                                <textarea id="message" class="form-control mx-3 pd-5" type="text" cols="1" rows="2" name="" id=""></textarea>
                            </div>
                            <input type="hidden" id="_token" value={{ csrf_token() }}>
                            <div class="col-3">
                                <button onclick="sendMessage({{ $id }}, {{ session('userid') }})" id="sendButton" class="btn btn-primary">Send</button>
                            </div>
                        </div>
                    </ul>
                </div>
